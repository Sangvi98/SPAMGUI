...
public class Main extends Application {
    ...
    final private int shapeSpeed = 800;
...
//            stackPane.getChildren().addAll(boardShade, gameOverCenter);
    ...
    public void start(Stage primaryStage) {
        ...
        left.setText("left");
        left.setPadding(new Insets(50, 50, 50, 50));//(top/right/bottom/left)
        Button rotate = new Button();
        rotate.setFont(Font.font ("Verdana", 20));
        rotate.setAlignment(Pos.TOP_CENTER);
        rotate.setText("rotate");
        //rotate.setAlignment(Pos.CENTER);
        rotate.setMinSize(100, 100);
        rotate.setPadding(new Insets(50, 50, 50, 50));
        Region space = new Region();
        space.setMinSize(50, 100);
        HBox rotateArea = new HBox();
        rotateArea.getChildren().addAll(space,rotate);
        ...
        reset.setText("reset");
        reset.setFont(Font.font ("Verdana", 20));
        reset.setAlignment(Pos.CENTER);
        reset.setMinSize(120, 100);


        HBox commands = new HBox();
        commands.getChildren().addAll(left,right);


        BorderPane buttonsBorderPane = new BorderPane();
        rotate.setAlignment(Pos.CENTER);
        buttonsBorderPane.setTop(rotateArea);
        buttonsBorderPane.setMaxHeight(700);
        buttonsBorderPane.setCenter(commands);
        buttonsBorderPane.setBottom(reset);
        buttonsBorderPane.setPadding(new Insets(200, 0, 0,0 ));
// The main layout of the game
        root = new HBox();
        root.getStyleClass().add("background");
        root.setPadding(new Insets(5.0));
        root.setSpacing(25.0);
        root.getChildren().addAll(borderPane, stackPane, buttonsBorderPane);
        ...
        scene.setOnKeyPressed((ke) -> {
            if (running) {
                ...
                if (ke.getCode().equals(KeyCode.Q)) {
                    gameInfo[0] = Integer.toString(board.getScore());
                    gameInfo[1] = Double.toString(timer.stop());
                    gameInfo[2] = Integer.toString(resetCount);
                    primaryStage.close();
                }
...
//                }
    ...
    public void startNewGame() {
        board = new Board(board.getScore(),board.getNumClearedLines());
        running = true;
        gameOver = false;
        pressed = true;
    ...
    public void createTransition() {
        ...
        pauseTransition = new PauseTransition(Duration.millis(800));
